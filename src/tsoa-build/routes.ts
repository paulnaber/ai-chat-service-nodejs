...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ChatsController } from './../app/chat/chatController.js';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import type { RequestHandler, Router } from 'express';
import { OpenApiController } from './../app/swagger.js';
  ...
  NewChat: {
    ...
    type: {
      ...
      nestedProperties: {
        lastActiveDate: {
          dataType: 'union',
          subSchemas: [{ dataType: 'datetime' }, { dataType: 'undefined' }],
        },
        title: {
          dataType: 'union',
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    function ChatsController_getChats(request: any, response: any, next: any) {
      const args = {};
      ...
      try {
        ...
        const promise = controller.getChats.apply(
          controller,
  ...
  app.get(
    ...
    function OpenApiController_getOpenapi(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getOpenapi.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
